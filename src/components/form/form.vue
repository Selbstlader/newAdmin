    ...
    >
      <el-row :gutter="props.rowGutter">
        <el-col
          ...
          v-for="(rowValue, rowKey) in form.columns"
          :key="rowKey"
        ...
        >
          ...
          >
            <!-- 同 -->
            <div v-if="rowValue.same" class="theSame_box" :style="`left: -${rowValue.title ? Number(props.labelWidth.split('px')[0]) + 50 : 50}px;`">
              <ZlTag
...
const state = reactive({
  form: {
    ...
    formData: props.zlvalue.formData.formData || {},
 ...
 */
watch(
  () => props.zlvalue.columns,
  (nl: any, ol: any) => {
    console.log(props.zlvalue, 'props.zlvalue');
 ...
 */
watch(
  () => props.zlvalue.formData,
  (nl: any, ol: any) => {
    console.log(props.zlvalue);
    state.form.formData = nl;
  }
);
